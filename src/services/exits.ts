...
import { ExitDifferences_BodyProps } from "@/pages/api/exits/differences";
...
export const getExitDifferences = async (body: ExitDifferences_BodyProps) => {
  
  let { data: exits } = await axios.post<Exit[]>(`${base_url}/api/exits/differences`, body)
