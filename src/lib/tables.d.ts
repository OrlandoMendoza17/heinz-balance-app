...
type P_ENT = {
  ...
  ENT_FEC_COL: Date;          // Preguntarle a yamileth - Posible hora de llegada a la romana 
...
type P_ENT_DI = {
  ...
  ENT_DI_PNC: number;           // Peso neto calculado
...
type P_ENT_DIF = {
  ...
  ENT_DIF_FEC: Date;   // Fecha en la que ocurre la diferencia 
...
// HO25_T_F0101 -> Registro general de personas
...
// HO25_T_F0101 Relacion entre el codigo del conductor y la placa del vehiculo que maneja
...
// HO25_T_F4930 Datos del vehiculo 
type T_F4930 = {
...
// H025T_PRO Tabla vacia 

// H025T_PROD Tabla vacia 


// H025T_TRA Tabla de los trasportes 
